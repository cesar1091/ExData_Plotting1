...
with(UCI_data, plot(x = Time, type = "l",
                    ...
                    xlab = ""))
# Repeating plot 3, but without legend border
...
legend("topright", lty = c(1,1,1), col = c("black", "red", "blue"),
       ...
       bty = "n")
# New plots
with(UCI_data, plot(x = Time, type = "l", y = Voltage, xlab = "datetime"))
with(UCI_data, plot(x = Time, type = "l", y = Global_reactive_power,
                    xlab = "datetime"))
dev.off()
setwd(cwd)